...
@router.get("/recent_posts", 
            tags = ["Posts"], 
            description = "Obtener el resumen de los post mas recientes",
            summary = "Post recientes"
)
...
@router.get("/recent_proj", 
            tags = ["Proyectos"], 
            description = "Obtener la informacion relacionada a los proyectos.",
...
def recent_proj( recent: bool | None = True ):
    ...
    resp, connection = add_tags(resp, connection)
